		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#jjmscomfacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jjmscomfacturas-display": {
								"semanticObject": "jjmscomfacturas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jjms.com.facturas",
									"url": sap.ui.require.toUrl("jjms/com/facturas")
								}
							}
						}
					}
